package com.myj.study.mapper.postgresql;
...
public interface CityMapper {
     ...
     * @return
     */
    @Insert("INSERT INTO t_test_city(city_id,city_name,city_py , prov_id , city_state) " +
     ...
     * @return
     */
    @Update("UPDATE t_test_city SET city_name=#{cityName} , city_py=#{cityPy} ,prov_id=#{provId} ,city_state=#{cityState}  " +
            "WHERE city_id=#{cityId}")
    int update(City city);

    @Delete("DELETE FROM t_test_city WHERE city_id =#{cityId}")
     ...
     * @return
     */
    @Select("SELECT * FROM t_test_city WHERE city_id = ${cityId}")
    @Results({
     ...
     * @return
     */
    @Select("SELECT * FROM t_test_city ")
